...
export default function DebounceExample() {
  ...
  const [searchableProduct, setSearchableProduct] = useState<Obj[]>(products);
  ...
  return (
    <div>
      ...
      <table>
        ...
        <tbody>
          {searchableProduct.map((post, index) => (
            <tr key={post.id} className="flex-row items-center">
              <td>{post.id}</td>
              <td>{post.title}</td>
